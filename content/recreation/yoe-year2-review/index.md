...
| ------------------------------------------------------------- | ------------------------------------------------------------ | ----------------------------------------------------------- | ------------------------------------------- |
| ![Schwinn AirDyne6](../yoe-year1-review/images/IMG_1217.jpeg) | ![Concept2 SkiErg](../yoe-year1-review/images/IMG_1218.jpeg) | ![Concept2 Rower](../yoe-year1-review/images/IMG_1219.jpeg) | ![Concept2 BikeErg](./images/IMG_2054.jpeg) |
...
<div id="chart-chart1" style="max-width: 640px; height: 200px;"></div>
...
<div id="chart-chart2" style="max-width: 640px; height: 200px;"></div>
...
<div id="chart-chart3" style="max-width: 640px; height: 250px;"></div>
...
<div id="chart-chart4" style="max-width: 640px; height: 250px;"></div>
...
<div id="chart-chart5" style="max-width: 640px; height: 200px;"></div>
...
<div id="chart-chart6" style="max-width: 640px; height: 300px;"></div>
...
<div id="chart-chart7" style="max-width: 640px; height: 200px;"></div>
...
<div id="chart-chart8" style="max-width: 640px; height: 250px;"></div>
...
<div id="chart-chart9" style="max-width: 640px; height: 250px;"></div>

Different workout types vary in length, just like Year 1:

<div id="chart-chart10" style="max-width: 640px; height: 250px;"></div>
...
<div id="chart-chart11" style="max-width: 640px; height: 200px;"></div>
...
<div id="chart-chart12" style="max-width: 640px; height: 250px;"></div>
...
<div id="chart-chart13" style="max-width: 640px; height: 150px;"></div>
...
const fixChart = (o) => ({
  ...
  echarts.init(document.getElementById('chart-chart1'), 'dark').setOption(fixChart(charts.execution.summary()));
  echarts.init(document.getElementById('chart-chart2'), 'dark').setOption(fixChart(charts.timeTrials()));
  echarts.init(document.getElementById('chart-chart3'), 'dark').setOption(fixChart(charts.compareSplits([52817150, 55235950])));
  echarts.init(document.getElementById('chart-chart4'), 'dark').setOption(fixChart(
  ...
  echarts.init(document.getElementById('chart-chart5'), 'dark').setOption(fixChart(
      charts.compareStrokedata(
        [52817150, 55235950],
        {
          dataZoom: [
  ...
  echarts.init(document.getElementById('chart-chart6'), 'dark').setOption(fixChart(charts.compareStrokeFrequency([52817150, 55235950])));
  echarts.init(document.getElementById('chart-chart7'), 'dark').setOption(fixChart(charts.steadyState()));
  echarts.init(document.getElementById('chart-chart8'), 'dark').setOption(fixChart(charts.ttConversionChart()));
  echarts.init(document.getElementById('chart-chart9'), 'dark').setOption(fixChart(charts.timeCommitment()));
  echarts.init(document.getElementById('chart-chart10'), 'dark').setOption(fixChart(charts.timeWorkoutDistribution()));
  echarts.init(document.getElementById('chart-chart11'), 'dark').setOption(fixChart(charts.variationWorkoutByDate()));
  echarts.init(document.getElementById('chart-chart12'), 'dark').setOption(fixChart(charts.variationWorkoutByPhase()));
  echarts.init(document.getElementById('chart-chart13'), 'dark').setOption(fixChart(charts.bikeergAirdyne()));
</script>
